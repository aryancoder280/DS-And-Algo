...
#include<cmath>
using namespace std;
//JUMP SEARCH IS KNOWN FOR LESS COMPARISON WHILE FINDIND AN ELEMNET COMPARE TO LINEAR SEARCH.
//TIME COMLEXITY=SQUARE ROOT(N)//BETTER THAN LINEAR SEARCH.
//BUT ARRAY MUST BE SORTED FOR THIS ALGO
...
*/
int k=sqrt(n);//variable k is for  jump size
   for(int i=0;i<n;i+=k)
   {
